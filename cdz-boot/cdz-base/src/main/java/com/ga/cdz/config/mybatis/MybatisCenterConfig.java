...
@MapperScan(basePackages = "com.ga.cdz.dao.center", sqlSessionTemplateRef = "sqlSessionTemplate")
public class MybatisCenterConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource)
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:/centerMapper/**Mapper.xml"));
        //***导入Mybatis配置***
