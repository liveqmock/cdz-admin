...
@MapperScan(basePackages = "com.ga.cdz.dao.charging", sqlSessionTemplateRef = "sqlSessionTemplate2")
public class MybatisChargingConfig {
    /**
     * 分页插件
     */
    @Bean
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource2") DataSource dataSource)
        ...
        bean.setTypeEnumsPackage("com.ga.cdz.domain.entity");
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:/chargingMapper/**Mapper.xml"));
        //***导入Mybatis配置***
